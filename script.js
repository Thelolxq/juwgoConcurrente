...
const heartCollisionWorkerTank1 = new Worker('workerCollision.js');
const heartCollisionWorkerTank2 = new Worker('workerCollision.js');
...
function checkHeartCollisionWithWorker(tank, worker) {
    if (heart) {
        ...
        worker.onmessage = function (e) {
            if (e.data.collision) {
                tank.lives++;
                heart = null; // El corazón desaparece tras la colisión
            }
        };
    }
}
